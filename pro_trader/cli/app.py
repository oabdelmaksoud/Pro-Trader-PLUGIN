...
def dashboard(
    ...
    # Dashboard needs broker, data, and monitor plugins — skip notifiers,
    # analysts, strategies to avoid unwanted external connections on startup.
    trader = ProTrader(plugin_categories={"broker", "data", "monitor"})
